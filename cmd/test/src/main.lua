...
T["extension => extension: table"] = dofile("tests/extension_table.lua")
T["extension => extension: string"] = dofile("tests/extension_string.lua")
T["extension => extension: exec"] = dofile("tests/extension_exec.lua")
