...
Next release: *0.7.0 Negligent Clamshell* +
+ New module: bitcask +
...
[NOTE]
====
[*] DSL modules are single Lua source that are loaded from the current working directory.
====
...
|=======================
|Tests |171/171
|Static executable bytes |9269248
|=======================
